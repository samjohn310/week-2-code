...
This dataset has columns of countries, and then a variety of years ranging from 1952 to 1992 with a new column for every five years. Each country has a score from -10 to 10 in each year.
...
The second column of the str function tells us that the variables are numeric data. We know that there are numeric and character data types, along with more specifications within these catagories.
...
```{r}
# what does the code below return? -7
...
dem_score$"1972"[dem_score$country == "United States"]
```
**Question**
If you were to read the above out loud, how would it read?
"dem underscore score dollarsign quote 1972 quote open bracket dem underscore score dollarsign country equals equals quote United States unquote close bracket."
